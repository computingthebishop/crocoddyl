...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_FRAME_VELOCITY_AUGMENTED_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_FRAME_VELOCITY_AUGMENTED_HPP_
...
class ResidualModelFrameVelocityAugmentedTpl : public ResidualModelAbstractTpl<_Scalar> {
 public:
  ...
  typedef ResidualDataFrameVelocityAugmentedTpl<Scalar> Data;
   ...
   */
  ResidualModelFrameVelocityAugmentedTpl(boost::shared_ptr<StateMultibody> state, const pinocchio::FrameIndex id,
  ...
  virtual ~ResidualModelFrameVelocityAugmentedTpl();
...
template <typename _Scalar>
struct ResidualDataFrameVelocityAugmentedTpl : public ResidualDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  ResidualDataFrameVelocityAugmentedTpl(Model<Scalar>* const model, DataCollectorAbstract* const data) : Base(model, data) {
    // Check that proper shared data has been passed
    DataCollectorMultibodyTpl<Scalar>* d = dynamic_cast<DataCollectorMultibodyTpl<Scalar>*>(shared);
    if (d == NULL) {
      throw_pretty("Invalid argument: the shared data should be derived from DataCollectorMultibody");
    }
    // Rx.resize(model->get_nr(), model->get_state()->get_nv() - model->get_nu());
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/frame-velocity_augmented.hxx"
