...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_FRAME_PLACEMENT_AUGMENTED_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_FRAME_PLACEMENT_AUGMENTED_HPP_
...
class ResidualModelFramePlacementAugmentedTpl : public ResidualModelAbstractTpl<_Scalar> {
 public:
  ...
  typedef ResidualDataFramePlacementAugmentedTpl<Scalar> Data;
   ...
   */
  ResidualModelFramePlacementAugmentedTpl(boost::shared_ptr<StateMultibody> state, const pinocchio::FrameIndex id,
  ...
  ResidualModelFramePlacementAugmentedTpl(boost::shared_ptr<StateMultibody> state, const pinocchio::FrameIndex id,
                                 const SE3& pref);
  virtual ~ResidualModelFramePlacementAugmentedTpl();
...
template <typename _Scalar>
struct ResidualDataFramePlacementAugmentedTpl : public ResidualDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/frame-placement_augmented.hxx"
