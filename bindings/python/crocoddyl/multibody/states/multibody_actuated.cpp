...
void exposeStateMultibodyActuated() {
  bp::register_ptr_to_python<boost::shared_ptr<crocoddyl::StateMultibodyActuated> >();

  bp::class_<StateMultibodyActuated, bp::bases<StateMultibody> >(
      "StateMultibodyActuated",
      ...
      bp::init<boost::shared_ptr<pinocchio::Model>, int >(
          bp::args("self", "pinocchioModel", "nr"),
      ...
      .def("integrate", &StateMultibodyActuated::integrate_x, bp::args("self", "x", "dx"),
      ...
      .def("Jdiff", &StateMultibodyActuated::Jdiff_Js,
      ...
      .def("Jintegrate", &StateMultibodyActuated::Jintegrate_Js,
      ...
      .def("JintegrateTransport", &StateMultibodyActuated::JintegrateTransport,
      ...
      .add_property("pinocchio",
                    bp::make_function(&StateMultibodyActuated::get_pinocchio, bp::return_value_policy<bp::return_by_value>()),
                    "pinocchio model");
}
