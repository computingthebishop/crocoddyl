...
void exposeDifferentialActionFreeFwdDynamicsActuated() {
  bp::register_ptr_to_python<boost::shared_ptr<DifferentialActionModelFreeFwdDynamicsActuated> >();

  bp::class_<DifferentialActionModelFreeFwdDynamicsActuated, bp::bases<DifferentialActionModelAbstract> >(
      "DifferentialActionModelFreeFwdDynamicsActuated",
      ...
      .def<void (DifferentialActionModelFreeFwdDynamicsActuated::*)(const boost::shared_ptr<DifferentialActionDataAbstract>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &DifferentialActionModelFreeFwdDynamicsActuated::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (DifferentialActionModelFreeFwdDynamicsActuated::*)(const boost::shared_ptr<DifferentialActionDataAbstract>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &DifferentialActionModelFreeFwdDynamicsActuated::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &DifferentialActionModelFreeFwdDynamicsActuated::createData, bp::args("self"),
           "Create the free forward dynamics differential action data.")
      .add_property(
          "pinocchio",
          bp::make_function(&DifferentialActionModelFreeFwdDynamicsActuated::get_pinocchio, bp::return_internal_reference<>()),
          "multibody model (i.e. pinocchio model)")
      .add_property("actuation",
                    bp::make_function(&DifferentialActionModelFreeFwdDynamicsActuated::get_actuation,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "actuation model")
      .add_property("costs",
                    bp::make_function(&DifferentialActionModelFreeFwdDynamicsActuated::get_costs,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "total cost model")
      .add_property(
          "armature",
          bp::make_function(&DifferentialActionModelFreeFwdDynamicsActuated::get_armature, bp::return_internal_reference<>()),
          bp::make_function(&DifferentialActionModelFreeFwdDynamicsActuated::set_armature),
  ...
  bp::class_<DifferentialActionDataFreeFwdDynamics, bp::bases<DifferentialActionDataAbstract> >(
      ...
      bp::init<DifferentialActionModelFreeFwdDynamicsActuated*>(bp::args("self", "model"),
