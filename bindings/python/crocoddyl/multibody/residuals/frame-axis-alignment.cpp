...
void exposeResidualFrameAxisAlignment() {
  ...
  bp::class_<ResidualModelFrameAxisAlignment, bp::bases<ResidualModelAbstract> >(
      ...
      bp::init<boost::shared_ptr<StateMultibody>, pinocchio::FrameIndex, Eigen::Vector3d, std::size_t, std::size_t>(
          ...
          ":param direction: frame axis that has to coincide with reference axis\n"
